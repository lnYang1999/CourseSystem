...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        ...
        request.setTemplateGroupId("2c699e1960904115953dcb456127342a");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5t9vM18kjzXcAHnkWfWW";
        //您的AccessKeySecret
        String accessKeySecret = "whue46LCBZrxRvkamgKqMhd1E145bf";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "I:\\IDEA Project\\course\\admin\\public\\static\\image\\小节视频\\23.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "test.mp4";
            CreateUploadVideoResponse createUploadVideoResponse = createUploadVideo(vodClient, fileName);            // 执行成功会返回VideoId、UploadAddress和UploadAuth
